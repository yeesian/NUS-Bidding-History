...
def parse_table(year, semester, bid_round):
    ...
    url = 'http://www.nus.edu.sg/cors/Reports/successbid_' + bid_round
    url += '_20' + year + '20' + year_next + 's' + str(semester) + '.html'
...
for bid_round in ['1A','1B','2A','2B', '3A','3B']:
    parse_table(year,2,bid_round)
    print '0' + str(year) + str(year+1) + ' S2 Round ' + bid_round + ' done!'
